...
\include{chapters/3-Theory.tex} % Theory
\include{chapters/4-Simulations.tex} % Simulation
\include{chapters/5-Experimental Work.tex} % Experiment
\include{chapters/6-Results and Discussion.tex} % Results
\include{chapters/7-Conclusion.tex} 
\listoftodos[Notes]
\include{chapters/8-Acknowledgment.tex}
