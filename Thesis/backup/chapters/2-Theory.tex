...
\begin{subequations}
	\begin{align*}
		...
		\text{s.t.} \quad & \bar{x}_{k+1}(t) = A \bar{x}_k(t) + B \bar{u}_k(t), \\
		& \bar{x}_0(t) = x_t, \\
		& \|\bar{u}_k(t)\|_{S_u} \leq 1, \ \forall t \in \mathbb{N}, \\
		& \|\bar{x}_k(t)\|_{S_x} \leq 1, \ \forall \left(A, B\right) \in \mathcal{C}, \ t \in \mathbb{N} .
	\end{align*}
\end{subequations}
